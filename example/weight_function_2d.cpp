...
std::variant<weif::point_aperture<value_type>, weif::annular_aperture<value_type>, weif::circular_aperture<value_type>, weif::square_aperture<value_type>>
make_aperture_filter(value_type aperture_scale, value_type central_obscuration, bool square) {
	...
	if (square) {
		return weif::square_aperture<value_type>{};
	}
